...
export default function CatalogItemEdit({ catalogItem, categories, publishers, authors }: Props) {
                        ...
                        <form onSubmit={handleSubmit} className="p-4 sm:p-6">
                            <div className="space-y-8">
                                ...
                                <div>
                                    ...
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Essential details about the catalog item</p>
                                ...
                                <div>
                                    <h3 className="text-lg font-medium text-gray-900 dark:text-gray-100">Additional Details</h3>
                                    <p className="mt-1 text-sm text-gray-500 dark:text-gray-400">Optional metadata and cataloging information</p>
                                    <div className="mt-4 grid grid-cols-1 gap-4 sm:grid-cols-2">
                                        <div>
                                        ...
                                        <div className="sm:col-span-2">
                                            ...
                                            <div className="mt-1 flex items-center gap-4">
                                                ...
                                                <span className="text-sm text-gray-500 dark:text-gray-400">
                                                    {coverImageName || (catalogItem.cover_image ? 'Current cover' : 'No file chosen')}
                                                </span>
                                                {coverImageName && (
                                                    <button
                                                        type="button"
                                        ...
                                        <div className="sm:col-span-2">
                                            <div className="flex items-center justify-between">
                                                ...
                                                <button
                                                    ...
                                                    className={`relative inline-flex h-6 w-11 flex-shrink-0 cursor-pointer rounded-full border-2 border-transparent transition-colors duration-200 ease-in-out focus:outline-none focus:ring-2 focus:ring-indigo-500 focus:ring-offset-2 ${data.is_active ? 'bg-indigo-600' : 'bg-gray-200 dark:bg-gray-700'
                                                        }`}
                                                    role="switch"
