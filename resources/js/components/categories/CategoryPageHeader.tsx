...
export default function CategoryPageHeader({ searchValue, onSearchChange, onAddCategory, onRefresh, isRefreshing = false }: CategoryPageHeaderProps) {
    return (
        <div className="mb-4 rounded-lg border border-gray-200 bg-white p-4 shadow-sm transition-colors duration-300 dark:border-[#3a3a3a] dark:bg-[#2a2a2a] sm:p-6">
            <div className="sm:hidden">
                <div className="mb-4 flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Category Management</h2>
                        <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                            Manage media categories and classifications
                        </p>
                    </div>
                    
                    <div className="flex-shrink-0">
                        <PrimaryButton onClick={onAddCategory} className="flex items-center gap-2 whitespace-nowrap">
            ...
            <div className="hidden sm:flex sm:items-center sm:justify-between sm:gap-4">
                <div className="flex-shrink-0">
                    <h2 className="text-2xl font-semibold text-gray-800 dark:text-gray-100">Category Management</h2>
