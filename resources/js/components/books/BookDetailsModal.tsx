...
export default function BookDetailsModal({ book, isOpen, onClose }: BookDetailsModalProps) {
    ...
    return (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-gray-500/75 p-2 sm:p-4 transition-colors duration-200 dark:bg-black/60">
            <div className="relative w-full max-w-3xl animate-fade-in rounded-2xl sm:rounded-3xl bg-white shadow-2xl max-h-[95vh] sm:max-h-[90vh] flex flex-col overflow-hidden dark:bg-[#2a2a2a]">
                {/* Close Button */}
                <button
                    onClick={onClose}
                        ...
                        >
                            <div className="overflow-hidden">
                                <div className="p-4 overflow-y-auto">
                                    <div className="mb-2">
                                        <h2 className="text-lg font-bold text-gray-900 dark:text-gray-100">Borrow Request</h2>
                                    ...
                                    <form onSubmit={handleSubmit} className="space-y-1.5">
                                        <div className="grid grid-cols-1 gap-2 sm:grid-cols-2">
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <div className="relative mt-0.5">
                                                    <input
                                                        ...
                                                        className={`h-8 w-full rounded-md border-gray-300 py-1 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 dark:border-[#3a3a3a] dark:bg-[#2a2a2a] dark:text-gray-100 ${memberValidation.isValid === true
                                            ...
                                            {memberValidation.isValid ? (
                                                <div className="sm:col-span-2 rounded-lg border border-indigo-200 bg-indigo-50 p-2 dark:border-indigo-900/30 dark:bg-indigo-900/10">
                                            ...
                                            <div className="sm:col-span-2">
                                                <h3 className="mb-1 text-xs font-semibold text-gray-700 dark:text-gray-300">Return Schedule</h3>
                                                <div className="grid grid-cols-2 gap-2">
                                                    {/* Return Date */}
                                                    <div>
                                                        <label className="block text-xs font-medium text-gray-700 dark:text-gray-300">
                                                    ...
                                                    <div>
                                                        ...
                                                        <div className="relative mt-0.5">
                                                            <Clock className="pointer-events-none absolute left-2 top-1/2 h-3.5 w-3.5 -translate-y-1/2 text-gray-400" />
                                                            <input
                                                                type="time"
                                            ...
                                            <div className="sm:col-span-2">
                                                ...
                                                <textarea
                                                    ...
                                                    rows={1}
                                                    className="mt-0.5 w-full rounded-md border-gray-300 py-1.5 text-sm shadow-sm focus:border-indigo-500 focus:ring-indigo-500 resize-none dark:border-[#3a3a3a] dark:bg-[#2a2a2a] dark:text-gray-100"
                                            ...
                                            {/* Notes */}
                                            <div className="sm:col-span-2">
                                                <label className="block text-xs font-medium text-gray-700 dark:text-gray-300">Notes / Message</label>
                                                <textarea
                                                    value={data.notes}
                                        ...
                                        {/* Buttons */}
                                        <div className="flex justify-end gap-2 border-t border-gray-200 dark:border-[#3a3a3a] pt-2 mt-2">
                                            <button
                                                type="button"
                                                onClick={() => setShowRequestForm(false)}
                                                className="rounded-full border border-gray-300 bg-white px-4 py-1.5 text-sm font-semibold text-gray-700 transition-all hover:border-gray-400 hover:bg-gray-50 active:scale-95 dark:border-[#3a3a3a] dark:bg-[#2a2a2a] dark:text-gray-300 dark:hover:bg-[#3a3a3a]"
                                            >
                                                Back
                                            </button>
                                            <button
