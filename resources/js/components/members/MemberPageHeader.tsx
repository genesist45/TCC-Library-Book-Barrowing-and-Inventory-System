...
export default function MemberPageHeader({ searchValue, onSearchChange, onRefresh, isRefreshing = false }: MemberPageHeaderProps) {
    return (
            ...
            <div className="sm:hidden">
                <div className="mb-4 flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                        <h2 className="text-xl font-semibold text-gray-800 dark:text-gray-100">Member Management</h2>
