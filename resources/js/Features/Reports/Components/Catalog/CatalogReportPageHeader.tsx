...
interface CatalogReportPageHeaderProps {
...
/**
 * Page header component for Catalog Reports
 * Includes title, subtitle, refresh button, and filter button
 */
export function CatalogReportPageHeader({
    isRefreshing,
    activeFilter,
    onRefresh,
    onOpenFilter,
    onClearFilter,
}: CatalogReportPageHeaderProps) {
    return (
                ...
                <div className="flex items-start justify-between gap-3">
                    <div className="flex-1 min-w-0">
                        ...
                        <p className="mt-1 text-xs text-gray-600 dark:text-gray-400">
                            View inventory and book statistics
                        </p>
                    </div>
